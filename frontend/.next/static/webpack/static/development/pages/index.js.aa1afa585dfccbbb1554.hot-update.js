...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      ...
      console.log(bodyScrollTop); // this.setState({ scroll: bodyScrollTop });

      console.log("hi"); // if (bodyScrollTop > 0) {
...
//# sourceMappingURL=index.js.aa1afa585dfccbbb1554.hot-update.js.map