    ...
    value: function render() {
      ...
      if (this.props.women) {
        ...
        var containers = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_WomenList__WEBPACK_IMPORTED_MODULE_3__["WomenListWrap"], {
          ...
          order: 0,
          style: {
            transform: "rotateY(".concat(transform.y, "deg) rotateX(").concat(transform.x, "deg) translate3d(0px, -").concat(this.state.scroll, "px, 0px)")
          },
...
//# sourceMappingURL=index.js.5369d4cfbe77d2f4448e.hot-update.js.map