...
var calcX = function calcX(x) {
  if (typeof window === "undefined") {
    ...
    if (x) {
      ...
      var _distFromCenter = x - center;

      var decimal = _distFromCenter / center; // number between .7 and .9
...
var calcY = function calcY(y) {
  if (typeof window === "undefined") {
    ...
    if (y) {
      ...
      var _distFromCenter2 = y - center;

      var matrix3DVal = _distFromCenter2 * 0.67 / center;
      return _distFromCenter2;
    } else return 0;
  }
};
...
var calcMatrix3D2 = function calcMatrix3D2(y) {
  if (typeof window === "undefined") {
    ...
    if (y) {
      ...
      var _distFromCenter3 = y - center;

      var matrix3DVal = _distFromCenter3 * 0.67 / center;
      console.log({
        center: center,
        distFromCenter: _distFromCenter3,
        matrix3DVal: matrix3DVal
      });
      return matrix3DVal;
    } else return 0;
  }
...
//# sourceMappingURL=index.js.41eb285e6c55a92a0a4c.hot-update.js.map