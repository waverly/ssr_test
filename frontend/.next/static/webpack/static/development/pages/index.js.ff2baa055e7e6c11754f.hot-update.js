    ...
    value: function render() {
      ...
      if (this.props.women) {
        var allWomen = this.props.women.map(function (woman) {
          console.log(_this2.props.women.indexOf(woman.name)); // make sure name exists

          var personId = woman.name.replace(/[^a-zA-Z ]/g, "").split(" ").join("");
...
//# sourceMappingURL=index.js.ff2baa055e7e6c11754f.hot-update.js.map