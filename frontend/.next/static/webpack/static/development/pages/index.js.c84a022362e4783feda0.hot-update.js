...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      console.log("on scroll is running"); // console.log(this.state.scrollTop);

      var bodyScrollTop = document.body.scrollTop; // window.pageYOffset !== undefined
      //   ? window.pageYOffset
      //   : (
      ...
      console.log(bodyScrollTop, window.pageYOffset); // this.setState({ scrollTop: bodyScrollTop });
    });
...
//# sourceMappingURL=index.js.c84a022362e4783feda0.hot-update.js.map