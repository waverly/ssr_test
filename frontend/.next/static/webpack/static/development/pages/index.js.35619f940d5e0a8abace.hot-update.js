...
var calcMatrix3D1 = function calcMatrix3D1(y) {
  if (typeof window === "undefined") {
    ...
    if (y) {
      var center = window.innerHeight / 2;
      var distFromCenter = y - center;
      var matrix3DVal = distFromCenter * 0.67 / center; // console.log({ center, distFromCenter, matrix3DVal });
...
//# sourceMappingURL=index.js.35619f940d5e0a8abace.hot-update.js.map