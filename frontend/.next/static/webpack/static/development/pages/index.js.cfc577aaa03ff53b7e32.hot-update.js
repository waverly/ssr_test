...
})(["transform:translate3d(0px,-1710px,0px);margin-top:", ";"], function (props) {
  return props.scroll ? "".concat(props.scroll, "px") : "-30vh";
});
  ...
  _createClass(WomenList, [{
    ...
    value: function render() {
      if (this.props.women) {
        ...
        console.log(this.props.scroll, "inside render in women list");
...
//# sourceMappingURL=index.js.cfc577aaa03ff53b7e32.hot-update.js.map