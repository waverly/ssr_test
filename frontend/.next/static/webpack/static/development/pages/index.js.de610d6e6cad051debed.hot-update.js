...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      var bodyScrollTop = window.pageYOffset; // console.log(
      //   `on scroll is running, bodyscrolltopis ${bodyScrollTop}, window page y offset is ${
      //     window.pageYOffset
      //   }`
      // );
...
//# sourceMappingURL=index.js.de610d6e6cad051debed.hot-update.js.map