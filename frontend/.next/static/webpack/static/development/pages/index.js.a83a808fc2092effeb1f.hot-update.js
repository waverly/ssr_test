...
var calcMatrix3D1 = function calcMatrix3D1(y) {
  if (typeof window === "undefined") {
    ...
    if (y) {
      var center = window.innerHeight / 2;
      var distFromCenter = y - center;
      var matrix3DVal = distFromCenter * 0.57 / center; // console.log({ center, distFromCenter, matrix3DVal });
...
//# sourceMappingURL=index.js.a83a808fc2092effeb1f.hot-update.js.map