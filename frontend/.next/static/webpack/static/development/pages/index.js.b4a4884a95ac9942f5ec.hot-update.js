...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      ...
      var bodyScrollTop = window.pageYOffset; // this.setState({ scrollTop: bodyScrollTop });

      console.log(bodyScrollTop, document.scrollTop, _this.state.scrollTop);
    });
  ...
  _createClass(WomenList, [{
    ...
    value: function componentDidMount() {
      ...
      document.addEventListener("scroll", this._throttleScroll); // window.addEventListener("resize", setBodyHeight);
...
//# sourceMappingURL=index.js.b4a4884a95ac9942f5ec.hot-update.js.map