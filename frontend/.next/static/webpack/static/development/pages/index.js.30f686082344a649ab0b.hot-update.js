...
function (_Component) {
  ...
  function Women() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      ...
      console.log(bodyScrollTop); // this.setState({ scroll: window.scrollTop });
    });
  ...
  _createClass(Women, [{
    ...
    value: function render() {
      ...
      if (typeof window === "undefined") {
        return 0;
      } else if (typeof window != "undefined" && this.state.scroll != null) {
        console.log("there is a window");
        document.addEventListener("scroll", this._onScroll);

        if (document.getElementById("womanList")) {// const womanListHeight = document.getElementById("womanList")
          //   .offsetHeight;
...
//# sourceMappingURL=index.js.30f686082344a649ab0b.hot-update.js.map