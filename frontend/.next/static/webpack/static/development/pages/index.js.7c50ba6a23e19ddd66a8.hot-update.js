...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_2__["throttle"](function (e) {
        console.log("in throttle");
        var bodyScrollTop = window.pageYOffset !== undefined ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop; //   this.setState({ scrollTop: bodyScrollTop });
      }, 1000);
    });
...
//# sourceMappingURL=index.js.7c50ba6a23e19ddd66a8.hot-update.js.map