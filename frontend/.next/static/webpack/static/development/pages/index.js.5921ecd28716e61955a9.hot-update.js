...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      console.log("on scroll is running");
      var bodyScrollTop = window.pageYOffset;
      console.log(bodyScrollTop, window.pageYOffset);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_throttleScroll", lodash__WEBPACK_IMPORTED_MODULE_2__["throttle"](_this._onScroll, 10));
  ...
  _createClass(WomenList, [{
    ...
    } // i do not want to run this the first time setBodyHeight is called.
...
//# sourceMappingURL=index.js.5921ecd28716e61955a9.hot-update.js.map