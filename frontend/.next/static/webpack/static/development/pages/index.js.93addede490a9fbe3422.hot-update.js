...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onScroll", function (e) {
      ...
      console.log("on scroll is running, bodyscrolltopis ".concat(bodyScrollTop, ", window page y offset is ").concat(window.pageYOffset));
...
//# sourceMappingURL=index.js.93addede490a9fbe3422.hot-update.js.map