...
var calcY = function calcY(y) {
  if (typeof window === "undefined") {
    ...
    if (y) {
      ...
      var distFromCenter = y - center; // console.log({ center, y, distFromCenter });

      return distFromCenter / 40;
    } else return 0;
  }
};
...
//# sourceMappingURL=index.js.0cb27f8d9992b4ffc451.hot-update.js.map