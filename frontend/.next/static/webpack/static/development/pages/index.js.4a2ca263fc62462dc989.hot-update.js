  ...
  _createClass(WomenList, [{
    ...
    value: function render() {
      if (this.props.women) {
        ...
        var containers = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 104
          },
          __self: this
        }, "containers") // <ContainerWrap>
        //   <ContainerTop>
        //     <div id="womanList" className="womenWrapper">
        //       {allWomen}
        //     </div>
        //   </ContainerTop>
        //   <ContainerMiddle>
        //     <div className="womenWrapper"> {allWomen}</div>
        //   </ContainerMiddle>
        //   <ContainerBottom>
        //     <div className="womenWrapper"> {allWomen}</div>
        //   </ContainerBottom>
...
//# sourceMappingURL=index.js.4a2ca263fc62462dc989.hot-update.js.map