...
})(["height:calc(100vh / 3);overflow:hidden;-webkit-box-sizing:border-box;box-sizing:border-box;outline:2px solid blue;.womenWrapper{margin-top:calc(-100vh / 3);transform:", ";}"], function (props) {
  return props.scroll ? "translate3d(0px, -".concat(props.scroll, "px, 0px)") : null;
});
...
})(["height:calc(100vh / 3);overflow:hidden;-webkit-box-sizing:border-box;box-sizing:border-box;outline:2px solid yellow;.womenWrapper{transform:translate3d(0px,-1710px,0px);margin-top:", ";}"], function (props) {
  return props.scroll ? "".concat(props.scroll, "px") : "-30vh";
});
var WrapperTest = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "WomenList__WrapperTest",
    ...
    value: function render() {
      if (this.props.women) {
        ...
        var containers = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ContainerWrap, {
          ...
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WrapperTest, {
...
//# sourceMappingURL=index.js.1b27eb31fc80168ffca2.hot-update.js.map